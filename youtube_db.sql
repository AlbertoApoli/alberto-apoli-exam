CREATE DATABASE  IF NOT EXISTS `youtube_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `youtube_db`;
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: youtube_db
-- ------------------------------------------------------
...
CREATE TABLE `youtube_channel_videos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`),
  UNIQUE KEY `video_link_UNIQUE` (`video_link`)
...
-- Dump completed on 2024-07-15 15:45:39
